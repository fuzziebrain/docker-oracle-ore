...
if [ -d $ORACLE_BASE/oradata/$ORACLE_SID ]; then
  ...
  # Run ORDS
  runuser oracle -s /bin/bash -c ${ORACLE_BASE}/scripts/${ORDS_RUN}
  ...
  # Setup ORE
  runuser oracle -s /bin/bash -c ${ORACLE_BASE}/scripts/${ORE_SETUP}

  # Install APEX
  runuser oracle -s /bin/bash -c ${ORACLE_BASE}/scripts/${APEX_INSTALL}

  # Install and run ORDS
  runuser oracle -s /bin/bash -c ${ORACLE_BASE}/scripts/${ORDS_INSTALL}
